...
<body>
      ...
      <div class="product">
        ...
        <div class="product-info">
          ...
          <div class="order-details">
            ...
            <select class="order-status" id="order-status" onchange="updateOrderStatus(this)" >
  ...
  function updateOrderStatus(selectElement) {
      ...
      document.getElementById("selected-status").value = selectedStatus;
  }

  function updateOrder() {
      var selectedStatus = document.getElementById("selected-status").value;
      window.location.href = <%=request.getContextPath() %> + "OrderOperationServlet?status=" + selectedStatus;
  }
  </script>
</body>
</html>