...
//		Insert Querry
		...
		public final static String INSERT_ORDER_ITEM = """
				INSERT INTO orderitem (order_id, product_id, quantity, total_price, order_date, status, user_id)
				VALUES (?, ?, ?, ?, ?, ?, ?)
				""";
...
//		Get all query
		...
		public final static String GET_ALL_ORDER = "SELECT * FROM orderItem";	
